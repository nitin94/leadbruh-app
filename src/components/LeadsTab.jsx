...
function LeadsTab({ leads, onSwitchToCapture, onEdit, onStartAppend, onDelete }) {
...
function LeadCard({ lead, expanded, onToggle, onEdit, onStartAppend, onDelete }) {
  ...
  return (
    <div className={`lead-card ${expanded ? 'expanded' : ''}`} onClick={onToggle}>
      <div className="lead-card-header">
        ...
        <div className="lead-card-header-actions">
          {expanded && onEdit && (
            <button
